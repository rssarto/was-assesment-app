...
public class BinaryDiffControllerTest {
    ...
    private static final String LEFT_API_SUFFIX_TEMPLATE = "%s/%s/left";
    private static final String RIGHT_API_SUFFIX_TEMPLATE = "%s/%s/right";
    @Autowired
    ...
    //TODO tests to assert the possible Exceptions the api can return.
